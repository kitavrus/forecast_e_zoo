// Package queries содержит embed.FS со всеми SQL-запросами фичи etl_validation.
//
// Контракт Get(name): возвращает текст запроса по имени файла без расширения.
// Если файл не найден — паника на старте сервиса (defensive: рассинхрон
// контракта repository ↔ embed недопустим).
package queries
